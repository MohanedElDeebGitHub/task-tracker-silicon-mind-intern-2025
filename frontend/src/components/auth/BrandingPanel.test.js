...
describe('BrandingPanel', () => {
  ...
  test('has correct CSS classes for styling', () => {
    ...
    expect(brandingPanel).toHaveClass('text-white', 'd-flex', 'flex-column', 'justify-content-center', 'p-5');
  });
  ...
  test('renders content with correct CSS classes', () => {
    ...
    const brandingContent = container.querySelectorAll('.branding-panel-content');
