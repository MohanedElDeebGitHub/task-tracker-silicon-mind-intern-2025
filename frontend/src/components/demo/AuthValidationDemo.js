    ...
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
        ...
        <form onSubmit={loginHook.handleLogin}>
          ...
          <div style={{ marginBottom: "10px" }}>
            <input
              ...
              onChange={(e) =>
                loginHook.updateField("password", e.target.value)
              }
              style={{
                padding: "8px",
                marginRight: "10px",
                border: loginHook.errors.password
                  ? "2px solid red"
                  : "1px solid #ccc",
              }}
            />
        ...
        <form onSubmit={signupHook.handleSignup}>
          <div style={{ marginBottom: "10px" }}>
            <input
              ...
              onChange={(e) =>
                signupHook.updateField("username", e.target.value)
              }
              style={{
                padding: "8px",
                marginRight: "10px",
                border: signupHook.errors.username
                  ? "2px solid red"
                  : "1px solid #ccc",
              }}
            />
          ...
          <div style={{ marginBottom: "10px" }}>
            <input
              ...
              style={{
                padding: "8px",
                marginRight: "10px",
                border: signupHook.errors.email
                  ? "2px solid red"
                  : "1px solid #ccc",
              }}
            />
          ...
          <div style={{ marginBottom: "10px" }}>
            <input
              ...
              onChange={(e) =>
                signupHook.updateField("password", e.target.value)
              }
              style={{
                padding: "8px",
                marginRight: "10px",
                border: signupHook.errors.password
                  ? "2px solid red"
                  : "1px solid #ccc",
              }}
            />
      ...
      >
        ...
        <ul>
          ...
          <li>Email: Required, must be valid email format</li>
          <li>
            Password: Required, 6-255 characters, must contain letters and
            numbers
          </li>
        </ul>
        <p>
